						...
						<fieldset style="color: #34000D;">
							...
							<div class="form-group row">
								...
								<div class="col-md-5" style="padding-left: 4px;">
									<sf:select class="form-controler form-control" id="categoryId"
							...
							<div class="form-group row">
								<label class="col-sm-3 col-form-label" for="unitPrice"><b>Unit
										Price:</b></label>
								<div class="col-md-6">
									<sf:input type="number" min="0.01" step="0.01" path="unitPrice" id="unitPrice"
										class="form-control" placeholder="Unit price in $" />
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<sf:input type="number" min="0.0" step="0.01" path="weight" id="weight"
										class="form-control" placeholder="Weight in grams" />
								</div>
							</div>

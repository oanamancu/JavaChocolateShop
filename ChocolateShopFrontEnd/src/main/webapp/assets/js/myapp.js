$(function() {
	...
	if ($table.length) {
		 ...
		 * columns : [ { data : 'code', bSortable : false, mRender :
		 * function(data, type, row) {
		 * 
		 * return '<img src="' + window.contextRoot + '/resources/images/' +
		 * data + '.jpg" class="dataTableImg"/>'; } }, { data : 'name' }, { data :
		 * 'brand' }, { data : 'unitPrice', mRender : function(data, type, row) {
		 * return '&#8377; ' + data } }, { data : 'quantity', mRender :
		 * function(data, type, row) {
		 * 
		 ...
		 * function(data, type, row) {
		 * 
		 * var str = ''; str += '<a href="' + window.contextRoot + '/show/' +
		 ...
		 * glyphicon-shopping-cart"></span></a>'; } } else { str += '<a
		 * href="' + window.contextRoot + '/manage/' + data + '/product"
